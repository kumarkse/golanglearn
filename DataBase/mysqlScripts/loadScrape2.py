...
backlog = {}
with open(cwd / "../../scrape1Backlog.json") as filer:
    backlog = json.load(filer)

content = {}
with open(cwd / "../../main_scraped_2.json") as filer:
    content = json.load(filer)

cursor.execute("create table backlog2 ( id int auto_increment , category varchar(50) , topic varchar(250) , link varchar (250) )")
...
cursor.execute("create table scraped_data_2_content (id int auto_increment,category varchar(50) , topic varchar(100) , content mediumtext);")
cursor.execute("create table scraped_data_2_comment (id int auto_increment, topic varchar(100) , comment mediumtext);")
